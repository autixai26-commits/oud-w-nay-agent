...
AR = {
    ...
    "typing": "لحظة…",
    'voice_list_summary': 'عندنا {count} في {title}. التفاصيل كاملة بالرسالة المكتوبة تحت 👇',
    'voice_failed': 'ما قدرت أفهم الرسالة الصوتية منيح 🙏 جرّب تبعتها كمان مرة، أو اكتبلي.',
    'ask_booking_type': 'أكيد، ولا يهمّك! 🌿 الحجز لعائلة ولا لشباب؟',
    'btn_family': '👨\u200d👩\u200d👧 عائلة',
    'btn_singles': '👥 شباب',
    'ask_date': 'حلو! أي يوم بتحبّ نحجزلك؟',
    'btn_today': 'اليوم',
    'btn_tomorrow': 'بكرا',
    'ask_period': 'تمام — وأي وقت بناسبك؟',
    'btn_noon': '🌤️ ظهراً 1–4',
    'btn_evening': '🌆 مساءً 5–8',
    'btn_late': '🌙 سهرة 9–12',
    'ask_hour': 'اختار الساعة يلي بتريحك:',
    'ask_party': 'وكم شخص رح تكونوا؟',
    'btn_party_11': '11 فأكثر',
    'ask_name': 'ضلّ إشي بسيط — شو اسمك الكريم؟',
    'ask_phone': 'وممكن رقم تلفونك تكرّماً؟ 🙏',
    'invalid_phone': 'ما ضبط معي الرقم — اكتبه أرقام بس تكرّماً، مثال 0791234567 🙏',
    ...
    'ask_party_exact': 'كم شخص بالضبط؟ اكتبلي الرقم تكرّماً.',
    'invalid_number': 'اكتبلي رقم صحيح تكرّماً 🙏',
    ...
    'admin_free_confirm': 'قصدك تحدّث حالة الطاولة {table} لمتاحة؟',
    'menu_photos_food': 'تفضّل منيو الأكل 🍽️',
    'menu_photos_drinks': 'تفضّل منيو المشروبات 🥤',
    'menu_photos_shisha': 'تفضّل منيو الأراجيل 🪈',
    'menu_photos_after': 'الأسعار بالدينار الأردني. حابب تحجز طاولة؟',
    'menu_photos_missing': 'صور المنيو مش متوفرة حالياً — بتقدر تسأل عن أي صنف أو سعر وأنا بجاوبك 🙏',
    'admin_block_name': 'حجز إداري',
    'admin_ask_block_hour': 'تمام — أي ساعة أحجزها؟',
    'admin_block_bad_hour': 'الدوام من 1 الظهر لـ 11 الليل — أي ساعة؟',
    'admin_table_blocked': 'تمام، الطاولة {table} صارت محجوزة {date} الساعة {time} ✅',
    'admin_table_taken': 'الطاولة {table} عليها حجز أصلاً {date}.',
    'admin_which_table': 'أي طاولة تقصد؟ اكتبلي رقمها تكرّماً.',
...
EN = {
    ...
    "typing": "One moment…",
    'voice_list_summary': 'We have {count} under {title}. Full details are in the text message below 👇',
    'voice_failed': "I couldn't quite catch that voice note 🙏 Please try again, or type it.",
    'ask_booking_type': 'Of course, my pleasure! 🌿 Is this booking for a family or a group of men?',
    'btn_family': '👨\u200d👩\u200d👧 Family',
    'btn_singles': '👥 Men only',
    'ask_date': 'Lovely! Which day would you like?',
    'btn_today': 'Today',
    'btn_tomorrow': 'Tomorrow',
    'ask_period': 'And which time suits you?',
    'btn_noon': '🌤️ Afternoon 1–4',
    'btn_evening': '🌆 Evening 5–8',
    'btn_late': '🌙 Late 9–12',
    'ask_hour': 'Please choose the time that suits you:',
    'ask_party': 'And how many of you will there be?',
    'btn_party_11': '11 or more',
    'ask_name': 'Just one more thing — may I have your name?',
    'ask_phone': 'And your phone number, please? 🙏',
    'invalid_phone': "I couldn't quite read that — digits only please, e.g. 0791234567 🙏",
    ...
    'ask_party_exact': 'Exactly how many people? Just type the number.',
    ...
    'admin_free_confirm': 'Do you mean set table {table} to available?',
    'menu_photos_food': 'Here is our food menu 🍽️',
    'menu_photos_drinks': 'Here is our drinks menu 🥤',
    'menu_photos_shisha': 'Here is our hookah menu 🪈',
    'menu_photos_after': 'Prices are in Jordanian dinars. Would you like to book a table?',
    'menu_photos_missing': "The menu photos aren't available right now — ask me about any dish or price and I'll tell you 🙏",
    'admin_block_name': 'Admin hold',
    'admin_ask_block_hour': 'Sure — what time shall I book it for?',
    'admin_block_bad_hour': 'We open 1pm to 11pm — which hour?',
    'admin_table_blocked': 'Done, table {table} is booked {date} at {time} ✅',
    'admin_table_taken': 'Table {table} already has a booking {date}.',
    'admin_which_table': 'Which table do you mean? Send me its number.',
