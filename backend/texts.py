...
AR = {
    ...
    'admin_busy_hint': 'لتصير الطاولة {table} محجوزة لازم يكون عليها حجز — استعمل /book للحجز اليدوي 🙏',
...
EN = {
    ...
    'admin_busy_hint': 'To make table {table} occupied it needs a booking — use /book for a manual one 🙏',
