...
# النطق الأردني للأرجيلة صوته قريب من g في go — لا الجيم القاهرية
# ولا القاف الحلقية الفصحى. «گ» (U+06AF) هو حرف الصوت g القياسي في
# الكتابة العربية، فهو أقرب ما نملك لإخبار المحرّك بالمطلوب.
# القيمة ثابت واحد: تبديلها سطر واحد إن أعطت أذن المالك حكماً آخر.
SHISHA_SPOKEN = "أرگيلة"
